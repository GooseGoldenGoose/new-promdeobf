...
- Sample 23: refreshed capture/closure stress fixture. The user expanded the source with nested closures capturing locals across direct, returned, block-local, and mutation cases. It was regenerated through local WeAreDevs Medium + formatter. Main resolves 14/15 dispatcher leaves (1 dead leaf pruned) across 8 VM functions, with 130 reaching definitions, 2 capture slots, 2 local cells, 8/8 upvalue accesses resolved, and no loop-carried lifetimes. Beta reports 14 blocks / 107 versioned assignments / 4 ordered indexed/member effect writes / 4 cross-state versions / 0 skipped assignments. Beta-CF now fails closed at closure entry 5 because that nested region's terminal VM return is not fully lowered; no fix has been applied yet.
