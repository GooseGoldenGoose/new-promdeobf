...
- Generic iterator `for ... in` is now implemented for the proven two-variable local-compiler shape in sample 53; normal + beta + beta-CF succeed and source/raw/formatted/normal/CF runtime parity is exact. Other unproven generic-for arities/shapes remain fail-closed.
