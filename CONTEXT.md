...
- Large untracked sample 5 still resolves the same closed 930/938 dispatcher graph with 8 dead leaves and 116 reachable functions. Reachability-driven closure discovery does not change that proven state count. Current scheduling changes 565 blocks through 67,545 dependency-safe adjacent crossings and sinks 445 unread pure writes; no safety-validator rejection is reported. The high swap count is a count of equivalent adjacent crossings, not independent semantic rewrites.
