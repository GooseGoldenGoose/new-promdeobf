...
local v12 = { pcall(function()
    return ("6fPrnRB9cRs" / (12341473 - ("CLfn" ^ 4547536)))
end) }
local v13 = v12[2]
    ...
    local v21 = { pcall(function()
        if ((v6(1, 2) == 1) or (v15 == v9)) then
            local v3 = tonumber(v2(tostring(({ pcall(function()
                return ("xXuD" / (2781463 - ("qK" ^ 16635040)))
            end) })[2]), ":(%d*):")())
            v1 = (v1 and (v14 == v3))
        end
        if v19 then
...
local v36 = function()
    if ((#v35) == 0) then
        v27 = (((v27 * 241) + 22191835244637) % 35184372088832)
        repeat
            v28 = ((v28 * 186) % 257)
        until (v28 ~= 1)
        local v1 = (v28 % 32)
...
for v40, v41 in pairs(getgc(true)) do
    if (typeof(v41) == v38[v39("E\205\195\129.", 33897642605992)]) then
        for v42 in ({ pairs(v41) })[1], ({ pairs(v41) })[2], ({ pairs(v41) })[3] do
            if tostring(v42).lower(tostring(v42)).find(tostring(v42).lower(tostring(v42)), v38[v39("\008\233y\255\215|\224D", 9713187541419)]) then
                print(v38[v39("F\173y\150\186)\200\1754i\219\r8\137h\150\159\158\240^\2027)", 12415634544277)], v42)
            end
        end
    end
end
