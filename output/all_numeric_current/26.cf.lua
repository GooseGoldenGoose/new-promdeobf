...
for r_v8_10 = r_v1_10, r_v4_2, r_v5_2 do
    ...
    local r_v1_16 = r_v2_5(r_v9_2, r_v8_10)
    ...
    for r_v13_5 = r_v1_17, r_v10_1, r_v11_1 do

        local r_v14_1 = r_v8_10 + r_v13_5
        ...
        if r_v2_8 then
            ...
            local r_v1_35 = r_v2_12(r_v14_3, r_v8_10, r_v13_5)
            ...
            local r_v1_37 = r_v2_13(r_v14_4, r_v8_10, r_v13_5)
    ...
    local r_v9_7 = "outer-end"

    local r_v1_29 = r_v2_9(r_v9_7, r_v8_10)

end

local r_v3_10 = 1

local r_v4_3 = r_v3_10

local r_v3_11 = -1

local r_v5_3 = r_v3_11

local r_v1_18 = 3

for r_v8_15 = r_v1_18, r_v4_3, r_v5_3 do

    local r_v1_30 = "print"

    local r_v2_10 = _env[r_v1_30]

    local r_v9_8 = "after-loop"

    local r_v1_31 = r_v2_10(r_v9_8, r_v8_15)
