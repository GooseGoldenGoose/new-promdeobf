...
local v12 = { pcall(function()
    return ("MKczz4R1yA" / (5577099 - ("PY7twad" ^ 3977098)))
end) }
local v13 = v12[2]
    ...
    local v21 = { pcall(function()
        if ((v6(1, 2) == 1) or (v15 == v9)) then
            local v3 = tonumber(v2(tostring(({ pcall(function()
                return ("Ffe3B3Pps3eHZ" / (2313906 - ("eg1ekCKsuiCS" ^ 965764)))
            end) })[2]), ":(%d*):")())
            v1 = (v1 and (v14 == v3))
        end
        if v19 then
...
local v37 = function()
    if ((#v36) == 0) then
        v27 = (((v27 * 113) + 3105170441637) % 35184372088832)
        repeat
            v28 = ((v28 * 237) % 257)
        until (v28 ~= 1)
        local v1 = (v28 % 32)
...
local v39 = function(v2, v3)
    ...
    if v1[v3] then
        ...
        local v6 = 255
        for v7 = 1, v5 do
            v6 = (((string.byte(v2, v7) + v37()) + v6) % 256)
            v1[v3] = (v1[v3] .. v4[(v6 + 1)])
        end
    end
    return v3
end
local v40 = setmetatable({}, { __index = v38, __metatable = v35 })
local v41 = { [v40[v39("\223", 1582621901536)]] = 1, [v40[v39("\174", 32752733567891)]] = 2 }
local v42, v43 = next(v41)
for v44 in ({ pairs(v41) })[1], ({ pairs(v41) })[2], ({ pairs(v41) })[3] do
    if (v44 ~= v42) then
        error(v40[v39("\021\029\170\203\157\021\030ljV\207\024\":\004\176\141\228]\246Q\218\182", 23702248762141)])
    end
    break
end
