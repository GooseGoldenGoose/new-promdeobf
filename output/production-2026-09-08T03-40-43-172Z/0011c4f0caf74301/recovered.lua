...
local v12 = { pcall(function()
    return ("EybA700DZO" / (1953574 - ("126s0YBVZkYQN" ^ 8137540)))
end) }
local v13 = v12[2]
    ...
    local v21 = { pcall(function()
        if ((v6(1, 2) == 1) or (v15 == v9)) then
            local v3 = tonumber(v2(tostring(({ pcall(function()
                return ("kc" / (5047976 - ("twQ53l" ^ 14089892)))
            end) })[2]), ":(%d*):")())
            v1 = (v1 and (v14 == v3))
        end
        if v19 then
...
local v37 = {}
local v38 = function()
    return v23[v22("\187\020J\210", 19904155935796)]
end
local v39 = function()
    if ((#v37) == 0) then
        v29 = (((v29 * 157) + 23559112207065) % 35184372088832)
        repeat
            v30 = ((v30 * 201) % 257)
        until (v30 ~= 1)
        local v1 = (v30 % 32)
...
local v40 = {}
v23 = setmetatable({}, { __index = v40, __metatable = nil })
v22 = function(v1, v2)
    local v3 = v40
    if v3[v2] then
    else
        ...
        local v6 = 191
        for v7 = 1, v5 do
            v6 = (((string.byte(v1, v7) + v39()) + v6) % 256)
            v3[v2] = (v3[v2] .. v4[(v6 + 1)])
        end
    end
    return v2
end
local v41 = tostring(v38)
if v41.lower(v41).find(v41.lower(v41), v23[v22("\017\008\252\150\207\028\184\131$\tX\209\199", 24155390209008)]) then
    local v42, v43 = pcall(v38)
    if (v43 ~= v23[v22("\194\012\018P", 20006989177956)]) then
        warn(v23[v22("\133k\211\218F\175'\223\250\027\129\245+\150\134", 18398858699127)])
        local v44 = true
    end
end
