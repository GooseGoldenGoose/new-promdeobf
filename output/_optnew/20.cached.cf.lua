...
local r_v3_3 = function(...)
    ...
    local r_v2_27 = _env[r_v1_2]
    
    local r_v5_21 = "#"
    
    r_v1_2 = r_v2_27(r_v5_21, unpack(r_v4_4))
    
    local r_v2_28 = 0
    
    local r_v3_4 = r_v1_2 == r_v2_28
    ...
    local r_v1_3 = "tostring"
    
    local r_v2_31 = _env[r_v1_3]
    
    r_v1_3 = r_v2_31(r_v12_2)
    
    local r_v6_39 = "concat"
    
    local r_v9_21 = _env[r_v6_39]
    
    r_v6_39 = r_v9_21(unpack(r_v4_4))
    
    local r_v5_22 = ","
    
    local r_v2_32 = r_v5_22 .. r_v6_39
    
    local r_v3_6 = r_v1_3 .. r_v2_32
...
r_v5_1 = r_v2_7(r_v9_1)

local r_v5_2 = "assert"

local r_v2_8 = _env[r_v5_2]
...
r_v5_2 = r_v2_8(r_v9_2)

local r_v5_3 = "assert"

local r_v2_9 = _env[r_v5_3]
...
r_v5_4 = r_v2_10(r_v9_4)

local r_v5_5 = "assert"

local r_v2_11 = _env[r_v5_5]
...
r_v5_5 = r_v2_11(r_v9_5)

local r_v5_6 = "assert"

local r_v2_12 = _env[r_v5_6]
...
r_v5_6 = r_v2_12(r_v9_6)

local r_v5_7 = "assert"

local r_v2_13 = _env[r_v5_7]
...
r_v5_7 = r_v2_13(r_v9_7)

local r_v5_8 = "assert"

local r_v2_14 = _env[r_v5_8]
...
r_v5_9 = r_v2_15(r_v9_9)

local r_v5_10 = "assert"

local r_v2_16 = _env[r_v5_10]
...
local r_v6_19 = function(...)
    ...
    local r_v3_16 = function(...)
        ...
        local r_v3_47 = function(...)
            ...
            local r_v2_62 = r_v12_24
            
            local r_v12_26 = "f"
            
            local r_v3_56 = r_v2_62[r_v12_26]
    ...
    r_v12_10[r_v2_44] = r_v3_16
    
    local r_v2_45 = "get"
    
    local r_v2_46 = r_v12_10[r_v2_45]
    ...
    local r_v3_18 = function(...)
        ...
        local r_v3_49 = function(...)
            ...
            local r_v3_57 = function(...)
                ...
                local r_v2_63 = r_v12_27
                
                local r_v12_28 = "f"
                
                local r_v3_58 = r_v2_63[r_v12_28]
        ...
        r_v12_25[r_v2_59] = r_v3_49
        
        local r_v2_60 = "get"
        
        local r_v2_61 = r_v12_25[r_v2_60]
...
r_v5_10 = r_v2_16(r_v9_10)

local r_v5_11 = "assert"

local r_v2_17 = _env[r_v5_11]
...
r_v5_11 = r_v2_17(r_v9_11)

local r_v5_12 = "assert"

local r_v2_18 = _env[r_v5_12]
...
r_v5_12 = r_v2_18(r_v9_12)

local r_v5_13 = "assert"

local r_v2_19 = _env[r_v5_13]
...
r_v5_13 = r_v2_19(r_v9_13)

local r_v5_14 = "assert"

local r_v2_20 = _env[r_v5_14]
...
r_v5_14 = r_v2_20(r_v9_14)

local r_v5_15 = "assert"

local r_v2_21 = _env[r_v5_15]
...
local r_v6_31 = function(...)
    ...
    local r_v12_16 = r_v3_27
    
    local r_v2_51 = 2
    
    local r_v3_28 = r_v12_16 + r_v2_51
...
r_v5_15 = r_v2_21(r_v9_15)

local r_v5_16 = "assert"

local r_v2_22 = _env[r_v5_16]
...
local r_v6_33 = function(...)
    ...
    local r_v12_17 = r_v3_29
    
    local r_v2_52 = 2
    
    local r_v3_30 = r_v12_17 - r_v2_52
...
local r_v6_35 = function(...)
    ...
    local r_v12_18 = r_v3_31
    
    local r_v2_53 = 2
    
    local r_v3_32 = r_v12_18 * r_v2_53
...
local r_v5_18 = "assert"

local r_v2_24 = _env[r_v5_18]
...
r_v5_18 = r_v2_24(r_v9_18)

local r_v5_19 = "assert"

local r_v2_25 = _env[r_v5_19]
...
local r_v6_37 = function(...)
    ...
    local r_v12_19 = r_v3_33
    
    local r_v2_54 = 2
    
    local r_v3_34 = r_v12_19 / r_v2_54
...
r_v5_19 = r_v2_25(r_v9_19)

local r_v5_20 = "print"

local r_v2_26 = _env[r_v5_20]

local r_v9_20 = "PASS"

r_v5_20 = r_v2_26(r_v9_20)
